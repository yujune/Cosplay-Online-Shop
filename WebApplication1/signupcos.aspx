<%@ Page Language="C#" MasterPageFile="~/Partical2.Master"  AutoEventWireup="true" CodeBehind="signupcos.aspx.cs" Inherits="WebApplication1.signupcos" %>
<asp:Content ID="Content" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	<style>
		...
		<table class="signupcos">
                    ...
                    <td><asp:TextBox ID="txtlastname" runat="server" Height="32px" Width="150px"  ></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
			...
			<tr><td><asp:Label ID="PasswordR" runat="server" Text="Password Repeat" CssClass="PasswordR"></asp:Label></td>
                    <td><asp:TextBox ID="txtpasswordr" runat="server" TextMode="Password" Height="32px" Width="150px" ></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" 
                    ErrorMessage="Please reenter your password" ControlToValidate="txtpasswordr" ForeColor="red">*</asp:RequiredFieldValidator></td></tr>
			
                    <tr><td><asp:Label ID="Contact" runat="server" Text="Contact Number" CssClass="Contact"></asp:Label></td>
                    <td><asp:TextBox ID="txtcontact" runat="server" Height="32px" Width="150px" ></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" 
                    ErrorMessage="Please enter your contact number" ControlToValidate="txtcontact" ForeColor="red">*</asp:RequiredFieldValidator><asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ControlToValidate="txtcontact" Display="None" ErrorMessage="The email is not in email format" ForeColor="Red" ValidateRequestMode="Enabled" ValidationExpression="^([\+]?(?:00)?[0-9]{1,3}[\s.-]?[0-9]{1,12})([\s.-]?[0-9]{1,4}?)$"></asp:RegularExpressionValidator></td></tr>
                    <tr><td>
