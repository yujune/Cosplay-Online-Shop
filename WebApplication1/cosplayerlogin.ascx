<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="cosplayerlogin.ascx.cs" Inherits="WebApplication1.cosplayerlogin" %>
<style>
		body {
			margin:0;
			padding:0;
		...
		<table>
                    ...
                    ErrorMessage="Please enter your password" ControlToValidate="txtpassword" ForeColor="red">*</asp:RequiredFieldValidator>
                     <asp:CustomValidator ID="CustomValidator" runat="server" Enabled="True" 
                    ErrorMessage="Invalid Username or Password" onservervalidate="Validate1">*</asp:CustomValidator> 
                    </td></tr>
        </table>
		<div>
			  <asp:ValidationSummary ID="ValidationSummary1" runat="server" DisplayMode="List" ShowMessageBox="true" ForeColor="red"/></div>
			<asp:Label ID="ErrorMsgTextBox" runat="server" Text=""></asp:Label>
