<%@ Page Language="C#" MasterPageFile="~/CosplayerShop1.Master" AutoEventWireup="true" CodeBehind="CosplayerGallery.aspx.cs" Inherits="Costume.CosplayerGallery" %>
        ...
        <div style="text-align:center">
             <div style="text-align:center">
                ...
                <div  style="margin: 0 auto; " class="auto-style13" >
                    ...
                    <tr><td ><h1 class="auto-style20">About Shop :</h1></td><td class="auto-style12"><asp:Label ID="Label5" runat="server" Text="We provide you up to 100 different costumes !" Font-Italic="False" Font-Size="X-Large" Font-Family="Arial"></asp:Label></td></tr>
                    </table>
                    <br />
                    <br />
                    <br />
